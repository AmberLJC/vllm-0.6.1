...
vllm serve microsoft/Phi-3-mini-128k-instruct  --scheduling-strategy qoe-avg --load-format dummy  --tensor-parallel-size 4 --trust-remote-code --max-num-batched-tokens 200000  --preemption-mode swap --swap-space 10 --preemption_freq 0.5 &
sleep 65
# 
cd /vllm/examples/request_dispatcher
